...
namespace MassDataApi.Data.Migrations
{
    public partial class IdentityTablesCreation : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MainCertificateId = table.Column<int>(type: "int", nullable: false)
                    ...
                    TranIt = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MainCertificates", x => x.MainCertificateId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TemporaryCertificateId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RegNumber = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FathersName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TemporaryCertificates", x => x.TemporaryCertificateId);
                });
